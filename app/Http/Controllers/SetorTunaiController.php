		...
		if ($cek_siswa!=null and $tabsiswa!=null and $cek_tabungan!=null ){
			if ($statusTabungan){
				...
				Session::flash("flash_notification", [
					"level" => "success",
					"icon" => "fa fa-check",
					"message" => "Transaksi Setor dengan Nominal ".$request->nominal." Berhasil!"
				]);
			}else{
				Session::flash("flash_notification", [
					"level" => "error",
					"icon" => "fa fa-check",
					"message" => "Transaksi Gagal! Status Tabungan Nonaktif!"
				]);
			}
        }
            ...
            Session::flash("flash_notification", [
                "level" => "error",
                "icon" => "fa fa-ban",
                "message" => "Transaksi Gagal! Siswa/Jenis Tabungan Tidak Terdaftar/Status Tabungan Non-Aktif!"
            ]);
        }
