            ...
            return Datatables::of($data) //->make(true);
                 ->addColumn('action', function($data) {
                     return view('datatable._action', [
                        ...
                        'confirm_message'    => 'Yakin Mau Menghapus Wali Kelas' . $data->nama_lengkap . '?'
                     ]);
            })
    ...
    public function destroy(Request $request, $id)
    {
		...
		if($kelas_guru == null){
			...
			Session::flash("flash_notification", [
				"level" => "success",
				"icon" => "fa fa-check",
				"message" => "Wali Kelas ".$nama_walikelas." Berhasil Dihapus!"
			]);
		}
			...
			Session::flash("flash_notification", [
				"level" => "warning",
				"icon" => "fa fa-check",
				"message" => "Gagal! Wali Kelas ".$nama_walikelas." Digunakan dalam Tabel Kelas!",
			]);
		}
